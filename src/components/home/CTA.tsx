// FILE: src/components/home/CTA.tsx (REPLACE ENTIRE FILE)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="bg-navy-850 rounded-lg p-10 md:p-16 text-center border border-slate-700/50">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/#branches" 
              className="inline-flex items-center justify-center bg-brand-blue text-white font-semibold py-3 px-8 rounded-md w-full sm:w-auto transition-all duration-300 transform hover:bg-brand-blue-hover hover:-translate-y-1 shadow-lg"
            >
