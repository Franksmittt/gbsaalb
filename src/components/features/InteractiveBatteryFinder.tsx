// FILE: src/components/features/InteractiveBatteryFinder.tsx (REPLACE ENTIRE FILE)
"use client";
...
const InteractiveBatteryFinder = () => {
    ...
    return (
        // This outer div handles the negative margin to overlap the hero section
        <div className="relative z-10 md:-mt-16">
            {/* This container div ensures consistent width and padding with other sections */}
            <div className="container mx-auto px-4">
                <div className="bg-white rounded-lg shadow-2xl p-6 md:p-8" id="vehicle-finder">
